...
export function Home() {
    return (
        <>
            <section id="hero" className="h-[75vh] flex items-center justify-center bg-zinc-800">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col items-center space-y-4">
                        ...
                        <a
                            href="#projects"
                            className="px-4 py-2 bg-zinc-700 text-white rounded-md hover:bg-zinc-600 transition duration-300 text-md font-semibold"
                        >
                            Ver Projetos
                        </a>
                    </div>
            ...
            <section id="about" className="py-20 bg-zinc-800">
                <div className=" container bg-zinc-800/30 p-8 rounded-xl mx-auto border border-zinc-700 shadow-lg">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="flex flex-col justify-center items-center space-y-6">
                            <div className="grid grid-cols-3 gap-6 w-full max-w-[900px]">
                                ...
                                <div className="bg-zinc-700/20 p-4 rounded-lg text-center">
                                    <span className="text-3xl font-bold text-white">3+</span>
                                    <p className="text-sm text-zinc-400 mt-1">Projetos</p>
                                </div>


                                <div className="bg-zinc-700/20 p-4 rounded-lg text-center">
                                    <span className="text-3xl font-bold text-white">2</span>
                                    <p className="text-sm text-zinc-400 mt-1">Anos de Experiência</p>
                                </div>


                                <div className="bg-zinc-700/20 p-4 rounded-lg text-center">
                                    <span className="text-3xl font-bold text-white">3º</span>
                                    <p className="text-sm text-zinc-400 mt-1">Ensino Médio Técnico Fiap School</p>
                                </div>
                            </div>
            ...
            <section id="projects" className="py-20 bg-zinc-800">
                <div className="container bg-zinc-800/30 rounded-xl mx-auto">
